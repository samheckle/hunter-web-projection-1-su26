...
Every class will submit two links:
- a link to the code repository 
- a link to the public facing file

## Why did we do this?

- Install a text editor (SublimeText, etc): This is where we will create, write, and code our files on our computer
- Install x-code tools: This allows us to use `git` commands that we will need in our class 2
- Setup Github account: This allows us to upload and store our files like google drive for sharing code. We can also publish our websites to the web
- Setup SSH keys: Syncs our computer with Github so that Github will recognize our computer. It is a "key" or special password for our computer to unlock github.